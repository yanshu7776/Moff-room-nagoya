  ...
  return (
    <div className="flex flex-col min-h-screen bg-custom-beige-unified">
      ...
      <main className="flex-1">
        <section className="bg-custom-beige-unified py-12 md:py-16 px-4">
          <div className="max-w-4xl mx-auto bg-custom-beige-dark rounded-lg shadow-xl p-6 sm:p-8 md:p-10 relative">
            <button
              onClick={() => router.back()}
