...
const localBusinessSchema = {
  ...
  review: [
    {
      "@type": "Review",
      author: { "@type": "Person", name: "お客様" },
      datePublished: "2025-11-06",
      reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
      reviewBody: "子供の1歳の誕生日のお祝いに両祖父母と集まるためにお借りしました。一升餅や選びとりカードなど、少しだけ机を動かせば十分なスペースでした。",
      name: "みんなでお祝いできました！",
    },
    {
      "@type": "Review",
      ...
      reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
      reviewBody: "ハロウィンパーティーの下見を兼ねてパーティー会場を利用させていただきました。広さ、雰囲気とも大変気に入りました。",
      name: "ハロウィン",
    },
    {
      "@type": "Review",
      ...
      reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
      reviewBody: "お部屋の中はクマいっぱいでとてもかわいいお部屋でした！プロジェクターもあり音楽を流したりすることもできとても楽し時間を過ごせました！",
      name: "かわいいくまのお部屋",
    },
    {
      "@type": "Review",
      ...
      datePublished: "2025-10-26",
      reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
      reviewBody: "とても綺麗で使いやすいです✨大人6人、子ども10人で利用しました。プロジェクターや可愛いくまさんのぬいぐるみがあり、とてもインスタ映えしました。",
      name: "おすすめのレンスペです♡",
    },
    {
      "@type": "Review",
      ...
      reviewBody: "3組6人で使用しました。おもちゃはいろんな種類があって、2歳の娘は喜んでいました。カトラリーも子供用のお皿が3皿あるなど充実していました。",
      name: "子連れでハロウィンママ会",
    },
    {
      "@type": "Review",
      ...
      reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
      reviewBody: "名古屋矢場町からすぐ立地の良さ！室内はたくさんのクマさんがお出迎えしてくれました♪ベビーからキッズまで遊べるおもちゃがたくさんあり、おむつ替えスペースも綺麗でした！",
    ...
    },
    {
      ...
      reviewRating: { "@type": "Rating", ratingValue: "5", bestRating: "5" },
      reviewBody: "お友達の家に行ったような感覚で、子どももママも始終リラックスして過ごせました！おもちゃも性別問わず遊べるものばかりで助かりました◎",
