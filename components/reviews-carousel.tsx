  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <div className="inline-flex items-center gap-4 bg-white shadow-lg rounded-full py-2 px-6">
          <Image
      ...
      <Carousel setApi={setApi} opts={{ loop: true }} className="relative px-10">
          ...
          {reviews.map((review, index) => (
            <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
              <div className="p-1 h-full">
                <Card className="p-6 bg-white shadow-lg h-full flex flex-col rounded-xl">
                  ...
                  <h3 className="font-bold text-lg text-custom-beige-dark mb-3">{review.title}</h3>
        ...
        <CarouselPrevious className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 rounded-full w-10 h-10 shadow-md border-none">
          <ChevronLeft className="h-6 w-6" />
        </CarouselPrevious>
        <CarouselNext className="absolute right-0 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 rounded-full w-10 h-10 shadow-md border-none">
