...
export default function FloatingCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 print:hidden">
      <div className="bg-custom-mint px-2 pt-2 pb-[calc(0.75rem+env(safe-area-inset-bottom))] md:p-3 shadow-[0_-4px_10px_rgba(0,0,0,0.1)]">
        <div className="container mx-auto flex items-stretch md:items-center justify-start md:justify-center gap-2 md:gap-4">
          ...
          <div className="flex-1 flex md:justify-center">
            ...
            >
              <div className="relative text-center w-full">
                <div className="inline-block bg-white text-[10px] md:text-sm text-gray-600 font-semibold px-2 md:px-3 py-1 rounded-full shadow-sm mb-[-12px] relative z-10">
                  <span className="md:hidden">他の店舗も見る</span>
                  <span className="hidden md:inline">他の店舗も見てみる</span>
                </div>
                <div className="bg-white border-2 border-blue-500 rounded-lg px-2 py-3 md:py-5 text-blue-600 font-jkg font-bold text-xs md:text-lg transition-transform duration-300 group-hover:scale-105 flex items-center justify-center gap-1.5 md:gap-2">
          ...
          <div className="flex-1 flex md:justify-center">
            ...
            >
              <div className="relative text-center w-full">
                <div className="inline-block bg-white text-[10px] md:text-sm text-pink-500 font-semibold px-2 md:px-3 py-1 rounded-full shadow-sm mb-[-12px] relative z-10">
                  【HP限定15%OFF】
                </div>
