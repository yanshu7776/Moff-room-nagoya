    ...
    extend: {
      colors: {
        ...
        "custom-beige": {
          ...
          unified: "rgb(255, 255, 255)", // 統一背景色 (白)
          accent: "rgb(254, 248, 174)", // アクセント用の明るい黄色
          border: "rgb(254, 248, 174)", // 枠線用の明るい黄色
          dark: "rgb(254, 248, 174)", // ヘッダー・フッター用の明るい黄色
          section: "rgb(250, 245, 220)", // セクション背景用の淡いクリーム色
        },
